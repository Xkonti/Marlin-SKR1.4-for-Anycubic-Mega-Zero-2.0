...
#define STRING_CONFIG_H_AUTHOR "Beniamin (Xkonti) Dudek" // Who made the changes.
...
#define MACHINE_UUID "6337710f-5ee5-458e-a784-d5f475e233b7"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 144.18
  #define DEFAULT_bedKi 28.58
  #define DEFAULT_bedKd 484.91
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.21, 160.87, 800, 385 } // (orig: 80, 80, 400, 385 for x16)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 150, 7500 }
...
#define DEFAULT_RETRACT_ACCELERATION  7500    // E acceleration for retracts
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.08 // (mm) Distance from real junction edge: 0.4 * (Jerk^2 / AccelPrinting)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -12, -3.163 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 34
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 3), (Y_MAX_POS - 3), 40 }
